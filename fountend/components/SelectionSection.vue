...
const grapes = [
    { 
        img: '/images/friendly01.jpg', 
        title: '友善大地', 
        desc: '這片溫暖肥沃的土地上，葡萄在自然與人之間找到最好的平衡。我們採用草生栽培方式，讓果園中的雜草自然生長，不僅保護土壤結構、減少水分流失，也為田間帶來更多有益生態，讓土地能夠自行呼吸與修復。' 
    },
    { 
        img: '/images/friendly02.jpg', 
        title: '陽光雨露', 
        desc: '彰化地區日照充足、雨水分布適中，為葡萄生長提供穩定而理想的環境。在枝條萌芽關鍵期，充足的陽光促進芽體活化，適量的水分則讓新梢生長均勻健壯，使葡萄能在良好的基礎下順利展開整個生長季。' 
    },
    { 
        img: '/images/friendly03.png', 
        title: '生態共鴨', 
        desc: '在葡萄園田間飼養鴨子，讓牠們成為天然的清道夫。鴨子能主動覓食田間害蟲與雜草，降低病蟲害發生，同時減少人為除蟲與化學用藥的需求。牠們的活動也促進土壤循環，形成自然共生的生態系統，讓葡萄在更健康的環境中成長。' 
    },
    { 
        img: '/images/friendly04.png', 
        title: '智慧溫室', 
        desc: '我們把最難照顧的環節，交給科技來完成。溫室設備結合機械化，減少病蟲害干擾，讓葡萄在穩定又乾淨的環境中慢慢長大，只留下更純粹、更美味的自然甜味。' 
    },
    { 
        img: '/images/friendly05.jpg', 
        title: '嚴選安心', 
        desc: '每一顆葡萄在出園前，皆經過嚴格篩檢與把關，以低農藥管理為基礎，檢測結果趨近於零農藥殘留。從田間到餐桌，清楚可追溯的來源，讓消費者安心品嚐每一口自然風味。' 
    }
]
